...
import { Theme, Link, Text, Button, Image, Icon, Box, Hr, List } from "@quarkly/widgets";
...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section padding="100px 0" sm-padding="40px 0" background="#efc5ff">
			...
			<Image
				height="100px"
				src="https://images.unsplash.com/photo-1607170475950-3023bc66be94?ixlib=rb-1.2.1&q=85&fm=jpg&crop=entropy&cs=srgb&w=2000"
				width="100px"
				flex="1 2"
				order="1"
				align-self="flex-end"
